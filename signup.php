...
<html lang="en">
  ...
  <body>
    <img src="signupphoto.webp" alt="">
      <div id="form">
            <h1 id="heading">SignUp</h1><br>
            <form name="form" action="sign.php" method="POST">
                <i class="fa fa-user fa-lg"></i>
                <input type="text" id="user" name="user" placeholder="Enter Username" required></br></br>
                <i class="fa-solid fa-envelope fa-lg"></i>
                <input type="email" id="email" name="email" placeholder="Enter Email" required></br></br>
                <i class="fa-solid fa-envelope fa-lg"></i>
                <input type="tel" id="number" name="num" placeholder="Enter mobile number" required></br></br>
